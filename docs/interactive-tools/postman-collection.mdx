...
Alternatively, you can import the collection directly into Postman using this URL:

<a href={`${Constants.DOCS_URL}/collection.json`} target="_blank" rel="noopener noreferrer">
  {`${Constants.DOCS_URL}/collection.json`}
</a>
  ...
  <div className="help-resources-box">
    ...
    <div className="help-content">
      ...
      <div className="help-actions">
        <a href={`${AppUrl()}/dashboard`} target="_blank" rel="noopener noreferrer" className="button button--primary">
