...
<div className="explorer-header">
  <div className="explorer-header-content">
    ...
    <p>
      A simple and intuitive interface for testing API endpoints with real-time
      responses
    </p>
    <div className="explorer-buttons">
      <a
        href="#example-processing-a-payment"
...
<div className="features-grid">
  <div className="feature-card">
    ...
    <p>
      Test API endpoints with your own parameters and see real-time responses
    </p>
  </div>
  <div className="feature-card">
    <h3>📋 Request Builder</h3>
    <p>
      Easily build API requests with a user-friendly interface for all
      parameters
    </p>
  </div>
  <div className="feature-card">
  ...
  <div className="step-content">
    ...
    <div className="parameter-details">
      ...
      <div className="detail-item">
        <span className="detail-icon">🚀</span>
        <span className="detail-text">
          Click <strong>Send Request</strong> to execute the API call
        </span>
      </div>
    </div>
  </div>
...
```bash
curl -X POST "{ApiBaseUrl()}/payments/process" \
...
<div className="faq-item">
  ...
  <p>
    Use the Create Subscription endpoint with test credentials to simulate
    recurring billing without processing real payments.
  </p>
</div>
...
<div className="faq-item">
  ...
  <p>
    Yes, any actions you take with the API Testing Tool will trigger
    corresponding webhook events if you have webhooks configured.
  </p>
</div>
