  ...
  <div className="workflow-steps">
    <div className="workflow-step">
      ...
      <div className="step-content">
        ...
        <ol>
          <li>Create a payment request using the <a href={getDocsUrl('/api-reference/payments/process-payment')}>Process a payment</a> endpoint</li>
          ...
          <li>Verify the payment status using the <a href={getDocsUrl('/api-reference/payments/verify-payment')}>Verify a payment</a> endpoint</li>
        </ol>
        <CodeBlock
          language="javascript"
...
{CodeExamples.PAYMENT_WORKFLOW}
    ...
    <div className="workflow-step">
      ...
      <div className="step-content">
        ...
        <ol>
          <li>Create a subscription using the <a href={getDocsUrl('/api-reference/subscriptions/create-subscription')}>Create a subscription</a> endpoint</li>
          ...
          <li>Verify the subscription status using the <a href={getDocsUrl('/api-reference/subscriptions/verify-subscription')}>Verify a subscription</a> endpoint</li>
        </ol>
        <CodeBlock
          language="javascript"
  ...
  <div className="next-steps-grid">
    ...
    <div className="next-step-card">
      ...
      <div className="next-step-card-content">
        ...
        <div className="next-step-action">
          <a href={getDocsUrl('/developer-guide/error-handling')} className="button button--primary">
