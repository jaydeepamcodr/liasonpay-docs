...
<div className="faq-section">
  <details className="faq-item">
    <summary><h3>Can I use the same API key for testing and production?</h3></summary>
  ...
  <details className="faq-item">
    <summary><h3>What happens if I expose my API key?</h3></summary>
